...
import net.ice.relic.core.rendering.backend.opengl.*;
import net.ice.relic.core.rendering.backend.opengl.model.Model;
import net.ice.relic.core.rendering.backend.opengl.rendering.buffer.*;
...
public class ShadowRenderer extends AbstractRenderer {
    ...
    protected void initShaders() {
        loadShader("shadow.vert", GLShader.ShaderType.VERTEX);
    }

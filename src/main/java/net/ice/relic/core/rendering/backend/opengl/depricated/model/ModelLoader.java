...
public class ModelLoader {
    ...
    private static void buildFrameMatrices(
            ...
            List<Bone> boneList,
            Animation.AnimatedFrame animatedFrame,
            int frame,
            Node node,
...
//    }
    ...
    public Model loadModel(Resource resource, int flags) {
        ...
        return load(aiScene, resource);
    }

    private Model load(AIScene aiScene, Resource resource) {
    ...
    private static List<Animation> processAnimations(AIScene aiScene, List<Bone> boneList, Node rootNode, Matrix4f globalInverseTransformation) {
        ...
        for (int i = 0; i < numAnimations; i++) {
            ...
            for (int j = 0; j < maxFrames; j++) {
                ...
                Arrays.fill(boneMatrices, new Matrix4f());

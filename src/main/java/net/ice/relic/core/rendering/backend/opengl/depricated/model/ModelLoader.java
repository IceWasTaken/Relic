...
public class ModelLoader {
    ...
    public ModelLoader(TextureCache textureCache, MaterialCache materialCache, ModelCache modelCache) {
...
//    }
    ...
    public Model loadModel(Resource resource, boolean animation) {
        return loadModel(resource, textureCache, materialCache, modelCache, aiProcess_GenSmoothNormals | aiProcess_JoinIdenticalVertices |
    ...
    private Model load(AIScene aiScene, TextureCache textureCache, Resource resource, MaterialCache materialCache, ModelCache cache) {

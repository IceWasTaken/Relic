package net.ice.talisman.gui.builder.registry;
...
public class WinRegistry implements WindowsRegistryAccessProvider {
    ...
    public String getValue(
            WindowsRegistryAccessProvider.RegistryHKey registryHKey, String key, String valueName ) throws WindowsRegistryAccessException
    {
        ...
        try
        {
            ...
            if (value != null) {
                ...
                if (m.matches()) {
                    value = getValue(WindowsRegistryAccessProvider.RegistryHKey.tryGetFromName(m.group(1)), m.group(2), m.group(3));
                }
            }
            return value;
        }
